...
const { createCoupon, getAllCoupons, deleteCoupon, updateCoupon } = require('../controller/coupon');
...
router.get(
  ...
  getAllCoupons,
  (req, res)=>{
    res.render('admins/coupon', { user: req.user, page: 'coupons',couponsList : req.coupons })
  })
router.post(
  '/coupon',
  requireSignin,
